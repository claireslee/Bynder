            ...
            for (int j = 0; j < people.size(); j++) {
                if (i != j) {
                    ...
                    (people.get(i).getAge() == people.get(j).getAge() - 1)) {
                        ...
                        if (people.get(i).getIs().substring(0,1).equals("p") && (!(people.get(j).getIs().substring(0,1).equals("y")))) {
                            counter += 7;
                        }
                        ...
                        if (people.get(i).getIc().substring(0,1).equals("J") && (!(people.get(j).getIc().substring(0,1).equals("B") || 
                        people.get(j).getIc().substring(0,1).equals("S")))) {
                            counter += 5;
                        }
                        ...
                        // MOVIE
                        if (people.get(i).getMov().substring(0,1).equals("c") && (!(people.get(j).getMov().substring(0,1).equals("r")))) {
                            counter += 3;
                        }
                        ...
                        if (people.get(i).getH1().substring(0,2).equals("sp") && (!(people.get(j).getH1().substring(0,2).equals("li")))) {
                            counter += 1;
                        }
                        ...
                        // HOBBY2
                        if (people.get(i).getH2().substring(0,2).equals("sp") && (!(people.get(j).getH2().substring(0,2).equals("li")))) {
                            counter += 1;
                        }
